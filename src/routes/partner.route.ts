...
import { getPartnerRole, managePartnerRole, updatePartnerRole } from '../global/roles';

const router = Router();

router.put('/bulk-update', authGuard.verifyRoles(updatePartnerRole), partnerController.updateVisible);
...
router.put('/:id', authGuard.verifyRoles(updatePartnerRole), validate(updatePartnerSchema), partnerController.updatePartner);
