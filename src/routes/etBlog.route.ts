...
router.get("/:id", authGuard.verifyRoles(manageEtBlogRole), etBlogController.getEtBlogById);
router.get("/", authGuard.verifyRoles(manageEtBlogRole), etBlogController.getAllEtBlogs);
