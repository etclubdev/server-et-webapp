    ...
    createAccount: async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            sendEmail(createdAccount.username, 'Password Reset Request - New Login Credentials',
                ...
                <ol>
                    <li><strong>Log in</strong> to your account at [Log-in URL].</li>
                    <li><strong>Change your password</strong> immediately after logging in by navigating to [Manage Personal Profile URL].</li>
                </ol>
